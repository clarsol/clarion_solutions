...
export const services = {
  ...
  "ai-workflows": {
    ...
    faq: [
      { q: "What kinds of businesses benefit most from AI workflows?",        a: "Businesses doing $1M+ in revenue that are still relying on manual processes to keep things running. If your team is spending meaningful time on repetitive tasks like data entry, follow-up emails, status updates, and scheduling, there's almost certainly a workflow that eliminates most of that." },
