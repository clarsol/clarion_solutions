...
export const metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/services/media-production` },
  openGraph: {
    title: service.metaTitle,
    description: service.metaDesc,
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: "Clarion Solutions — Media Production North Dallas" }],
  },
