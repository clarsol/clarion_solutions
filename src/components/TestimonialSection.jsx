...
export default function TestimonialSection() {
  ...
  return (
    <section className="section-pad" style={{ background: "#0e0e0e" }}>
      ...
      >
        <div style={{ color: "#C9A84C", fontSize: "16px", letterSpacing: "4px", marginBottom: "16px" }}>
          ★★★★★
        </div>
        <p
          style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
          <span style={{ fontSize: "16px", letterSpacing: "2px", textTransform: "uppercase", color: "#F5F1E8" }}>
            Jensen | SKM Performance
          </span>
          <span style={{ fontSize: "14px", color: "#9E9A92" }}>
